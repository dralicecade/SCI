...
source("AncTable.R")
anc_Table <- ancova_Table(df, changeVal, preVal, Group, "SF-36")
...
source("AncTable.R")
anc_Table <- ancova_Table(df, changeVal, preVal, Group, "ASIA")
...
source("Lmer_Model_Table.R")
lmer <- Lmer_Model_Plot(SSSMQ, SSSMQ$Ave_pain_bearability_week,  model, "SSSQM")
